  ...
  return (
    <>
      ...
      <main id="main">
        ...
        {/* Pillar — internal links to core resources */}
        <section className="bg-background" aria-labelledby="ressourcer">
          <div className="mx-auto max-w-6xl px-4 py-20 lg:py-28">
            <header className="max-w-2xl mb-14">
              ...
              >
                Ressourcer til butikschefer og Amero-konsulenter
              </p>
              <h2
                id="ressourcer"
                tabIndex={-1}
                className="mt-5 text-primary scroll-mt-24 focus:outline-none leading-tight"
                style={{ fontSize: "clamp(1.75rem, 3vw, 2.5rem)" }}
              >
                Nem oplæring i kassesystem – samlet ét sted
              </h2>
              <p
                className="mt-6 text-foreground/80 leading-relaxed"
                style={{ fontSize: "1.125rem" }}
              >
                FlexPOS onboarding af nye medarbejdere skal være forudsigelig,
                tryg og hurtig at komme i gang med. Vælg den vej, der passer
                jeres rolle – test selve oplevelsen i prototypen, eller find
                den fulde opsætningsvejledning til Amero-konsulenter.
              </p>
            </header>

            <nav
              aria-label="Kerneressourcer"
              className="grid gap-8 md:grid-cols-2"
            >
              <Link
                to="/prototypen"
                className="group relative block h-full bg-white p-10 rounded-md border border-soft hover:border-accent hover:shadow-lg transition-all focus-visible:outline-offset-4"
                style={{ borderTopWidth: "4px", borderTopColor: "#233d68" }}
              >
                <MonitorPlay
                  size={36}
                ...
                />
                <h3
                  className="text-primary mb-3 leading-snug"
                ...
                <p
                  ...
                  style={{ fontSize: "1rem" }}
                >
                  Oplev hvordan nem oplæring i kassesystem fungerer i praksis.
                  Et trygt sandbox-miljø, hvor butikschefer kan se hele
                  onboarding-flowet, før det rulles ud til medarbejderne.
                </p>
                <span
              ...
              >
                ...
                <p
                  ...
                  style={{ fontSize: "1rem" }}
                >
                  Den komplette designguide til at konfigurere FlexPOS
                  onboarding af nye medarbejdere hos kunden – med klare trin,
                  komponenter og anbefalinger til en ensartet udrulning.
                </p>
                <span
                  className="inline-flex items-center gap-2 font-semibold group-hover:gap-3 transition-all"
                  style={{ color: "#4FAED1" }}
                >
                  Åbn opsætningsguiden
                  <ArrowRight size={18} aria-hidden="true" />
                </span>
              </Link>
            </nav>
